...
<div class="w3-display-container" style="margin-bottom:50px">
  <img src="<?php echo get_template_directory_uri(); ?>/images/beach3.jpg" style="width:100%">
...
<div class="w3-half w3-container">
  <div class="w3-topbar w3-border-amber">
    <img src="<?php echo get_template_directory_uri(); ?>/images/cellphone.jpg" style="width:100%">
...
<div class="w3-half w3-container">
  <div class="w3-topbar w3-border-amber">
    <img src="<?php echo get_template_directory_uri(); ?>/images/sealions.jpg" style="width:100%">
    <h2>Super Offers</h2>
...
<div class="w3-half w3-container">
  <div class="w3-topbar w3-border-orange">
    <img src="<?php echo get_template_directory_uri(); ?>/images/truck.jpg" style="width:100%">
...
<div class="w3-half w3-container">
  <div class="w3-topbar w3-border-orange">
    <img src="<?php echo get_template_directory_uri(); ?>/images/nowornever.jpg" style="width:100%">
